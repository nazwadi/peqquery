...
NPCSpecialAttacks = namedtuple('NPC_Special_Attacks', ['id', 'name'])
npc_special_attacks = [
    NPCSpecialAttacks(id=1, name='Summon'),
    NPCSpecialAttacks(id=2, name='Enrage'),
    NPCSpecialAttacks(id=3, name='Rampage'),
    NPCSpecialAttacks(id=4, name='Area Rampage'),
    NPCSpecialAttacks(id=5, name='Flurry'),
    NPCSpecialAttacks(id=6, name='Triple Attack'),
    NPCSpecialAttacks(id=7, name='Quad Attack'),
    NPCSpecialAttacks(id=8, name='Dual Wield'),
    NPCSpecialAttacks(id=9, name='Bane Attack'),
    NPCSpecialAttacks(id=10, name='Magical Attack'),
    NPCSpecialAttacks(id=11, name='Ranged Attack'),
    NPCSpecialAttacks(id=12, name='Unslowable'),
    NPCSpecialAttacks(id=13, name='Unmezable'),
    NPCSpecialAttacks(id=14, name='Uncharmable'),
    NPCSpecialAttacks(id=15, name='Unstunable'),
    NPCSpecialAttacks(id=16, name='Unsnareable'),
    NPCSpecialAttacks(id=17, name='Unfearable'),
    NPCSpecialAttacks(id=18, name='Immune to Dispel'),
    NPCSpecialAttacks(id=19, name='Immune to Melee'),
    NPCSpecialAttacks(id=20, name='Immune to Magic'),
    NPCSpecialAttacks(id=21, name='Immune to Fleeing'),
    NPCSpecialAttacks(id=22, name='Immune to Non-Bane Damage'),
    NPCSpecialAttacks(id=23, name='Immune to Non-Magical Damage'),
    NPCSpecialAttacks(id=24, name='Will Not Aggro'),
    NPCSpecialAttacks(id=25, name='Immune to Aggro'),
    NPCSpecialAttacks(id=26, name='Resist Ranged Spells'),
    NPCSpecialAttacks(id=27, name='See Through Feign Death'),
    NPCSpecialAttacks(id=28, name='Immune to Taunt'),
    NPCSpecialAttacks(id=29, name='Tunnel Vision'),
    NPCSpecialAttacks(id=30, name='Does NOT buff/heal friends'),
    NPCSpecialAttacks(id=31, name='Unpacifiable'),
    NPCSpecialAttacks(id=32, name='Leashed'),
    NPCSpecialAttacks(id=33, name='Tethered'),
    NPCSpecialAttacks(id=34, name='Destructible Object'),
    NPCSpecialAttacks(id=35, name='No Harm from Players'),
    NPCSpecialAttacks(id=36, name='Always Flee'),
    NPCSpecialAttacks(id=37, name='Flee Percentage'),
    NPCSpecialAttacks(id=38, name='Allow Beneficial'),
    NPCSpecialAttacks(id=39, name='Disable Melee'),
    NPCSpecialAttacks(id=40, name='Chase Distance'),
    NPCSpecialAttacks(id=41, name='Allow Tank'),
    NPCSpecialAttacks(id=42, name='Ignore Root Aggro'),
    NPCSpecialAttacks(id=43, name='Casting Resist Diff'),
    NPCSpecialAttacks(id=44, name='Counter Avoid Damage'),
    NPCSpecialAttacks(id=45, name='Proximity Aggro'),
    NPCSpecialAttacks(id=46, name='Immune Ranged Attacks'),
    NPCSpecialAttacks(id=47, name='Immune Client Damage'),
    NPCSpecialAttacks(id=48, name='Immune NPC Damage'),
    NPCSpecialAttacks(id=49, name='Immune Client Aggro'),
    NPCSpecialAttacks(id=50, name='Immune NPC Aggro'),
    NPCSpecialAttacks(id=51, name='Modify Avoid Damage'),
    NPCSpecialAttacks(id=52, name='Immune Fading Memories'),
]
